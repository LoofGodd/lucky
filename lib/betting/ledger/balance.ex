defmodule Betting.Ledger.Balance do
  use Ash.Resource,
  ...
  balance do
    transfer_resource Betting.Ledger.Transfer
  ...
  relationships do
    belongs_to :transfer, Betting.Ledger.Transfer do
      attribute_type AshDoubleEntry.ULID
      allow_nil? false
      attribute_writable? true
    end

    belongs_to :account, Betting.Ledger.Account do
      allow_nil? false
      attribute_writable? true
    end
  end
